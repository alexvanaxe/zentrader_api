...
other content types.  Also provide deserialization, allowing parsed data to be
...
class ReportTotalProfitMonthlySerializer(serializers.Serializer):
    """
    Serializer from the total profit accumulated by month from one year
    """
    total_monthly_profit = serializers.DictField()
