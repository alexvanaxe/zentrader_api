...
or other content types.  Also provide deserialization, allowing parsed data
...
class ExperienceDataSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        fields = ('pk', 'owner', 'category', 'creation_date', 'stock',
                  'amount', 'analysis', 'price', 'archived', 'nickname',
                  'favorite', 'limit', 'stop_gain', 'stop_loss',
                  'estimated_date', 'target', 'favorite',
                  'get_intent_display', 'intent', 'stock_data',
                  'action', 'detailed')
...
class ExperienceDataSerializerDetailed(serializers.ModelSerializer):
    ...
    class Meta:
        fields = ('pk', 'owner', 'owner_data', 'creation_date', 'stock',
                  'amount', 'price', 'archived', 'analysis', 'nickname',
                  'category', 'category_display', 'categories', 'limit',
                  'stop_gain', 'stop_loss', 'target', 'get_intent_display',
                  'intent', 'intents', 'stock_data', 'action', 'target_gain',
                  'detailed', 'operation_limit', 'cost', 'stock_cost',
                  'operation_average_price', 'average_cost',
                  'average_stock_cost', 'target_gain_total_percent',
                  'target_gain_percent', 'experience_gain',
                  'experience_gain_percent', 'experience_total_gain_percent',
                  'favorite', 'stop_loss_result', 'stop_loss_percent',
                  'stop_loss_total_percent', 'estimated_date')

        read_only_fields = ('creation_date', 'owner', 'owner_data',
                            'operation_gain', 'detailed', 'target_gain',
                            'operation_limit', 'cost', 'stock_cost',
                            'operation_average_price', 'average_cost',
                            'average_stock_cost', 'target_gain_total_percent',
                            'target_gain_percent', 'experience_gain',
                            'experience_gain_percent',
                            'experience_total_gain_percent',
                            'stop_loss_result', 'stop_loss_percent',
                            'intents', 'stop_loss_total_percent',
